...
import com.shihang.zxing.camera.CameraManager;
import com.shihang.zxing.decode.BitmapDecoder;
import com.shihang.zxing.decode.DecodeThread;
import com.shihang.zxing.utils.BeepManager;
import com.shihang.zxing.utils.BitmapUtils;
import com.shihang.zxing.utils.CaptureActivityHandler;
import com.shihang.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,OnClickListener {
	...
	private void initCrop() {
		...
		mCropRect = new Rect(x, scanCropView.getTop(), width + x, height + y);
	}
